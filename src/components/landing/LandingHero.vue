<template>
  <section id="hero">
    <div class="hero-text" data-speed="0.001">
      <h1 class="hero-title">IT Development Team</h1>
      <base-cta-button href="#projects-section" class="hero-btn"
        >Projects</base-cta-button
      >
    </div>
...
.hero-img-box {
  ...
  position: relative;
  user-select: none;
  box-shadow: 4px -3px 4px #00000040;
}
...
@media (max-width: 1240px) or (max-device-height: 800px) {
  .hero-img-box:nth-of-type(1) {
    left: 5vw;
    width: 35vw;
  }
...
@media (max-width: 500px) or (max-device-height: 800px) {
  .hero-img-box:nth-of-type(1) {
    height: 80%;
    width: 80%;
    left: 0;
